...
import { BooleanCondicion, DateCondicion, Filtro, NumberCondicion, SelectableCondicion, StringCondicion } from "@swai/core";

type PrismaFilterType = Prisma.IntFilter  | Prisma.StringFilter | Prisma.BoolFilter | Prisma.DateTimeFilter;
...
export class CoreFiltroToPrismaFilterMapper {
    static map(filtro: Filtro): PrismaFilter {
        ...
        if (!condicion) throw new Error('Error al mapear Filtros del Core a filtros de Prisma');
