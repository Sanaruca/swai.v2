...
import {
    EstudianteDTO,
    generar_carnet_estudiantil,
    generar_constancia_de_estudios,
    generar_informacion_del_estudiante,
    NIVEL_ACADEMICO,
    TIPO_DE_ESTUDIANTE,
} from '@swai/core';
import {
...
@Component({
  ...
  styleUrl: './perfil_estudiante.page.component.css',
})
export class PerfilEstudiantePageComponent implements OnInit {
  @ViewChild(EliminarEstudianteModalComponent)
  eliminar_estudiante_modal!: EliminarEstudianteModalComponent;
  ...
  protected imprimir_menu: MenuItem[] = [
    ...
    },
    {
      ...
      command: () => {
        ...
        generar_carnet_estudiantil(this.estudiante);
      },
    },
    {
