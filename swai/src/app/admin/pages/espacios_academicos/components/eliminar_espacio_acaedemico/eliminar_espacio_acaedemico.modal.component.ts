...
@Component({
  ...
  styleUrl: './eliminar_espacio_acaedemico.modal.component.css',
})
export class EliminarEspacioAcaedemicoModalComponent {
  ...
  protected eliminar() {
    ...
    this.api.client.espacios_academicos.eliminar_espacio_academico
      .mutate(this.espacio_academico.id)
      .then(() => {
        this.succes.emit();
        this.hide();
      });
