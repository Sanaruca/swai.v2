...
export class ConfiguracionPageComponent {
  ...
  protected guardar() {
    ...
    this.api.client.institucion.actualizar_datos_institucionales
      .mutate({
        actualizacion: {
          ...
          periodo_academico_actual: this.form.get('periodo_academico_actual')
            ?.value!,
          inicio_de_periodo_academico: this.form.get(
            'inicio_de_periodo_academico'
          )?.value!,
          fin_de_periodo_academico: this.form.get('fin_de_periodo_academico')
            ?.value!,
