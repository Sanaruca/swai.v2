...
import {
  CantidadDeEmpleadosDTO,
  CantidadDeEspaciosAcademicosDTO,
  CantidadDeEstudiantesDTO,
  CantidadDeRecursosDTO,
  RegistroRecienteDTO,
} from '@swai/server';
...
export class DashboardPageComponent implements OnInit {
  ...
  /* .............................. data inicial .............................. */
  protected registros_recientes = this.route.snapshot.data[
    'registros_recientes'
  ] as RegistroRecienteDTO[];
  protected cantidad_de_estudiantes = this.route.snapshot.data[
    'cantidad_de_estudiantes'
  ] as CantidadDeEstudiantesDTO;
  protected cantidad_de_empleados = this.route.snapshot.data[
