...
export enum AwIllustration {
  NO_DATA = 'no-data',
  VOID = 'void',
}

@Component({
  selector: 'aw-illustration',
  ...
  `,
  template: `
    @if (name === AwIllustration.NO_DATA) {
    <svg
    ...
    >
      ...
      />
      <circle cx="190.15351" cy="24.95465" r="20" fill="var(--p-primary-500)" />
    ...
    } @else if (name === AwIllustration.VOID) {
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 750 500">
      <g id="freepik--background-complete--inject-87">
        ...
        <path
          ...
          style="fill:#e0e0e0"
        ></path>
        <rect x="394.17" width="2.58" height="43.98" style="opacity:0.2"></rect>
      </g>
      <g id="freepik--Lamp--inject-87">
        <path
...
export class IllustrationComponent {
  protected AwIllustration = AwIllustration;

  @Input() name!: AwIllustration | string;
}
